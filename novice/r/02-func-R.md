...
#### Challenges
  ...
  **Hint:** Since your function is only plotting the data, you do not need to use a `return` statement because the plots created inside the function will automatically be displayed.
