...
Import the [health](health.csv) dataset. Have a look at the different
...
You will need to get your data in a certain format to be analyzed so that data
are easy to analyzed, visualize, and model. Three tools can help you in your
task: `reshape2`, `stringr`, and `plyr`.
